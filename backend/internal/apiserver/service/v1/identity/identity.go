...
func DefaultPermissions() []*iapiserver.IdentityPermissionDefinition {
	items := []struct{ code, domain, resource, action string }{
		...
		{"appstudio.agent.runtime.logs.read", "appstudio", "studio_application_agent_runtime_log", "read, list"},
...
func DefaultRolePermissions() map[string][]string {
	userPermissions := []string{
		...
		"appstudio.application.read", "appstudio.application.manage", "appstudio.agent.read", "appstudio.agent.runtime.logs.read", "appstudio.agent.operate",
