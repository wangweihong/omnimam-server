...
func DefaultPermissions() []*iapiserver.IdentityPermissionDefinition {
	items := []struct{ code, domain, resource, action string }{
		...
		{"agent.workspace.read", "agent", "agent_workspace_binding", "read"}, {"agent.memory.read", "agent", "agent_memory", "read"},
		...
		{"appstudio.workspace.read", "appstudio", "studio_workspace, studio_source_file", "read, list, search"}, {"appstudio.workspace.write", "appstudio", "studio_change_set, studio_workspace_revision", "apply_change_set, restore_revision"},
...
func DefaultRolePermissions() map[string][]string {
	userPermissions := []string{
		...
		"appstudio.application.read", "appstudio.application.manage", "appstudio.workspace.read", "appstudio.workspace.write",
