...
func (s *identityV11Store) ListRoles(ctx context.Context, req *iapiserver.IdentityRoleListRequest) ([]*iapiserver.IdentityRole, int64, error) {
...
func (s *identityV11Store) GetRole(ctx context.Context, id string) (*iapiserver.IdentityRole, error) {
	var item iapiserver.IdentityRole
	err := s.ds.db.WithContext(ctx).Where("id = ?", id).First(&item).Error
	return &item, err
}
func (s *identityV11Store) CreateRole(ctx context.Context, role *iapiserver.IdentityRole) (*iapiserver.IdentityRole, error) {
...
func (s *identityV11Store) UpdateRole(ctx context.Context, role *iapiserver.IdentityRole) (*iapiserver.IdentityRole, error) {
...
func (s *identityV11Store) ReplaceRolePermissions(ctx context.Context, id string, permissionCodes []string) error {
...
func (s *identityV11Store) ListGroups(ctx context.Context, req *iapiserver.IdentityGroupListRequest) ([]*iapiserver.IdentityGroup, int64, error) {
...
func (s *identityV11Store) GetGroup(ctx context.Context, id string) (*iapiserver.IdentityGroup, error) {
...
func (s *identityV11Store) CreateGroup(ctx context.Context, group *iapiserver.IdentityGroup) (*iapiserver.IdentityGroup, error) {
	err := s.ds.db.WithContext(ctx).Create(group).Error
	return group, err
}
func (s *identityV11Store) UpdateGroup(ctx context.Context, group *iapiserver.IdentityGroup) (*iapiserver.IdentityGroup, error) {
...
func (s *identityV11Store) ReplaceGroupMembers(ctx context.Context, id string, userIDs []string) error {
	return s.ds.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
...
func (s *identityV11Store) ReplaceGroupRoles(ctx context.Context, id string, roleIDs []string) error {
	return s.ds.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
...
func (s *identityV11Store) ListResourceGrants(ctx context.Context, resourceType, resourceID string, req *iapiserver.IdentityResourceGrantListRequest) ([]*iapiserver.IdentityResourceAccessGrant, int64, error) {
...
func (s *identityV11Store) CreateResourceGrant(ctx context.Context, grant *iapiserver.IdentityResourceAccessGrant) (*iapiserver.IdentityResourceAccessGrant, error) {
	err := s.ds.db.WithContext(ctx).Create(grant).Error
	return grant, err
}
func (s *identityV11Store) UpdateResourceGrant(ctx context.Context, grant *iapiserver.IdentityResourceAccessGrant) (*iapiserver.IdentityResourceAccessGrant, error) {
...
func (s *identityV11Store) RevokeResourceGrant(ctx context.Context, id string) error {
	now := imachinery.Now()
...
func (s *identityV11Store) ListServiceAccounts(ctx context.Context, req *iapiserver.IdentityServiceAccountListRequest) ([]*iapiserver.IdentityServiceAccount, int64, error) {
...
func (s *identityV11Store) GetServiceAccount(ctx context.Context, id string) (*iapiserver.IdentityServiceAccount, error) {
	var item iapiserver.IdentityServiceAccount
	err := s.ds.db.WithContext(ctx).Where("id = ?", id).First(&item).Error
	return &item, err
}
func (s *identityV11Store) CreateServiceAccount(ctx context.Context, account *iapiserver.IdentityServiceAccount, _ []string) (*iapiserver.IdentityServiceAccount, error) {
	err := s.ds.db.WithContext(ctx).Create(account).Error
	return account, err
}
func (s *identityV11Store) UpdateServiceAccount(ctx context.Context, account *iapiserver.IdentityServiceAccount, _ []string) (*iapiserver.IdentityServiceAccount, error) {
...
func (s *identityV11Store) SetServiceAccountStatus(ctx context.Context, id, status string) (*iapiserver.IdentityServiceAccount, error) {
	var current iapiserver.IdentityServiceAccount
...
func (s *identityV11Store) RotateServiceAccountCredential(ctx context.Context, id string) (*iapiserver.IdentityServiceAccountCredentialResponse, error) {
...
var _ store.IdentityAdminStore = (*identityV11Store)(nil)
