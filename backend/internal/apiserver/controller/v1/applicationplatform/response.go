...
var applicationPlatformErrors = map[int]errorDefinition{
	code.ErrAIAppProviderCapabilityDirectoryUnreadable:      {name: "ERR_AIAPP_PROVIDER_CAPABILITY_DIRECTORY_UNREADABLE"},
	code.ErrAIAppProviderCapabilityYAMLInvalid:              {name: "ERR_AIAPP_PROVIDER_CAPABILITY_YAML_INVALID"},
	code.ErrAIAppProviderCapabilitySchemaInvalid:            {name: "ERR_AIAPP_PROVIDER_CAPABILITY_SCHEMA_INVALID"},
	code.ErrAIAppProviderCapabilitySchemaVersionUnsupported: {name: "ERR_AIAPP_PROVIDER_CAPABILITY_SCHEMA_VERSION_UNSUPPORTED"},
	code.ErrAIAppProviderCapabilityIDDuplicated:             {name: "ERR_AIAPP_PROVIDER_CAPABILITY_ID_DUPLICATED"},
	code.ErrAIAppProviderCapabilityEngineTypeMissing:        {name: "ERR_AIAPP_PROVIDER_CAPABILITY_ENGINE_TYPE_MISSING"},
	code.ErrAIAppProviderCapabilityAdapterMissing:           {name: "ERR_AIAPP_PROVIDER_CAPABILITY_ADAPTER_MISSING"},
	code.ErrAIAppProviderCapabilityExecutorMissing:          {name: "ERR_AIAPP_PROVIDER_CAPABILITY_EXECUTOR_MISSING"},
	code.ErrAIAppProviderCapabilityVariantInvalid:           {name: "ERR_AIAPP_PROVIDER_CAPABILITY_VARIANT_INVALID"},
	...
	code.ErrAIAppProviderCapabilityIDReserved:               {name: "ERR_AIAPP_PROVIDER_CAPABILITY_ID_RESERVED"},
