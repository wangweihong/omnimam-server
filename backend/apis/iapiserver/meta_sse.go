...
const (
	...
	UserEventCanvasRunCreated          = "canvas.run.created"
	UserEventCanvasRunStarted          = "canvas.run.started"
	UserEventCanvasRunProgressed       = "canvas.run.progressed"
	UserEventCanvasRunSucceeded        = "canvas.run.succeeded"
	UserEventCanvasRunFailed           = "canvas.run.failed"
	UserEventCanvasRunCancelled        = "canvas.run.cancelled"
	UserEventCanvasNodeReady           = "canvas.node.ready"
	UserEventCanvasNodeQueued          = "canvas.node.queued"
	UserEventCanvasNodeStarted         = "canvas.node.started"
	UserEventCanvasNodeProgressed      = "canvas.node.progressed"
	UserEventCanvasNodeOutputAvailable = "canvas.node.output_available"
	UserEventCanvasNodeSucceeded       = "canvas.node.succeeded"
