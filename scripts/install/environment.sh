...
# ProviderCapability 是 API 与 Worker 共享的只读 Provider 模型、operation 和参数约束清单。
readonly APISERVER_PROVIDER_CAPABILITY_DIRECTORY=${APISERVER_PROVIDER_CAPABILITY_DIRECTORY:-/opt/omnimam/provider-capabilities}
